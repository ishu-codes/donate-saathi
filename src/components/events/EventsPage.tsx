...
const events = [
  {
    ...
    description: "Join us as we plant trees and flowers to beautify local community spaces and promote environmental sustainability.",
    image: "https://images.unsplash.com/photo-1552664688-cf412ec27db2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    date: "May 15, 2023",
  ...
  },
  {
    ...
    description: "Volunteer to teach basic skills and engage in fun learning activities with children from underserved communities.",
  ...
  },
  {
    ...
    description: "Spend time with elderly residents at local care homes, providing companionship and assistance with various activities.",
  ...
  },
  {
    ...
    description: "Guide and inspire young adults through career counseling, skill development, and personal growth activities.",
  ...
  },
  {
    ...
    description: "Join our effort to clean local beaches and raise awareness about plastic pollution and marine conservation.",
    image: "https://images.unsplash.com/photo-1622403498309-1e3496cea590?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    date: "June 24, 2023",
  ...
  },
  {
    ...
    description: "Volunteer at our healthcare camp providing basic health checks and education on preventive healthcare.",
  ...
  },
  {
    ...
    description: "Teach basic programming skills to teenagers and help them build their first web applications.",
  ...
  },
  {
    ...
    description: "Guide aspiring leaders through interactive sessions on leadership skills, team management, and effective communication.",
  ...
  },
  {
    ...
    description: "Learn and participate in sustainable urban farming techniques to promote food security and environmental sustainability.",
  ...
  },
  {
    ...
    description: "Help prepare and distribute meals to homeless and underprivileged communities in the city.",
    image: "https://images.unsplash.com/photo-1593113616828-3f21c325ae42?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    date: "August 2, 2023",
  ...
  },
  {
    ...
    description: "Facilitate art activities for children with special needs to promote emotional expression and development.",
    image: "https://images.unsplash.com/photo-1607457561901-e6ec3a6d16cf?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    date: "August 8, 2023",
  ...
  },
  {
    ...
    description: "Share your professional expertise with students and young professionals seeking career advice and guidance.",
...
const categories = [
  ...
  },
  {
    ...
    description: "Contribute to projects that protect and restore our environment",
    ...
    <div className="w-full bg-gray-50 min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-green-600 to-green-700 py-20 px-6 md:px-10 lg:px-20">
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Volunteer Events</h1>
            <p className="text-green-100 max-w-2xl mx-auto text-lg mb-8">
              Find opportunities to make a difference in your community through our organized events.
              Join fellow volunteers and contribute to meaningful causes.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-10 lg:px-20 bg-white">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-gray-800 mb-12 text-center">Volunteer Categories</h2>
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-10 text-center relative overflow-hidden">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto relative z-10">
              If you're an NGO or organization looking to host an event on our platform,
              we'd love to partner with you to amplify your impact.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
